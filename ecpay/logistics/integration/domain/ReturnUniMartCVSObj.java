...
/**
 * 超商取貨逆物流訂單(統一超商B2C)物件
 * @author mark.chiu
 *
 */
public class ReturnUniMartCVSObj {
...
//	}
	...
	/**
	 * 取得PlatformID 特約合作平台商代號 由綠界科技提供，此參數為專案合作的平台商使用，一般廠商介接請放空值。若為專案合作的平台商使用時，MerchantID 請帶賣家所綁定的 MerchantID。
	 * @return PlatformID
	 */
	...
	/**
	 * 設定PlatformID 特約合作平台商代號 由綠界科技提供，此參數為專案合作的平台商使用，一般廠商介接請放空值。若為專案合作的平台商使用時，MerchantID 請帶賣家所綁定的 MerchantID。
	 * @param platformID
	 */
	...
	public String toString() {
		return "ReturnUniMarkCVSObj [MerchantID=" + MerchantID + ", AllPayLogisticsID=" + AllPayLogisticsID
