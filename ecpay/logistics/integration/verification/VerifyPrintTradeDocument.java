...
public class VerifyPrintTradeDocument extends LogisticsVerifyBase{
	public VerifyPrintTradeDocument(){
		super();
	}
	
	public String getAPIUrl(String mode){
		Element ele = (Element)doc.getElementsByTagName("printTradeDocument").item(0);
		String url = "";
	...
	public void verifyParams(PrintTradeDocumentObj obj){
