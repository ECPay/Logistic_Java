...
public class VerifyReturnUniMartCVS extends LogisticsVerifyBase{
	public VerifyReturnUniMartCVS(){
		super();
	}
	
	public String getAPIUrl(String mode){
		Element ele = (Element)doc.getElementsByTagName("ReturnUniMartCVS").item(0);
		String url = "";
	...
	public void verifyParams(ReturnUniMartCVSObj obj){
