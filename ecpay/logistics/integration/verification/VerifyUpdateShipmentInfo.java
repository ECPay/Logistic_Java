...
public class VerifyUpdateShipmentInfo extends LogisticsVerifyBase{
	public VerifyUpdateShipmentInfo(){
		super();
	}
	
	public String getAPIUrl(String mode){
		Element ele = (Element)doc.getElementsByTagName("UpdateShipmentInfo").item(0);
		String url = "";
	...
	public void verifyParams(UpdateShipmentInfoObj obj){
