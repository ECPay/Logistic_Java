...
public class VerifyReturnCVS extends LogisticsVerifyBase{
	public VerifyReturnCVS(){
		super();
	}
	
	public String getAPIUrl(String mode){
		Element ele = (Element)doc.getElementsByTagName("ReturnCVS").item(0);
		String url = "";
	...
	public void verifyParams(ReturnCVSObj obj){
