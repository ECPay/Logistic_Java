...
public class VerifyReturnHiLifeCVS extends LogisticsVerifyBase{
	public VerifyReturnHiLifeCVS(){
		super();
	}
	
	public String getAPIUrl(String mode){
		Element ele = (Element)doc.getElementsByTagName("ReturnHiLifeCVS").item(0);
		String url = "";
	...
	public void verifyParams(ReturnHiLifeCVSObj obj){
