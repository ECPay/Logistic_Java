...
public class VerifyUpdateStoreInfo extends LogisticsVerifyBase{
	public VerifyUpdateStoreInfo(){
		super();
	}
	
	public String getAPIUrl(String mode){
		Element ele = (Element)doc.getElementsByTagName("UpdateStoreInfo").item(0);
		String url = "";
	...
	public void verifyParams(UpdateStoreInfoObj obj){
