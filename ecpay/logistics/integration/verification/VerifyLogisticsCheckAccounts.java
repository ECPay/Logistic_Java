...
public class VerifyLogisticsCheckAccounts extends LogisticsVerifyBase{
	public VerifyLogisticsCheckAccounts(){
		super();
	}
	
	public String getAPIUrl(String mode){
		Element ele = (Element)doc.getElementsByTagName("LogisticsCheckAccounts").item(0);
		String url = "";
	...
	public void verifyParams(LogisticsCheckAccountsObj obj){
