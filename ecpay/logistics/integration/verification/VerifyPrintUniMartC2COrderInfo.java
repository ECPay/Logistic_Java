...
public class VerifyPrintUniMartC2COrderInfo extends LogisticsVerifyBase{
	public VerifyPrintUniMartC2COrderInfo(){
		super();
	}
	
	public String getAPIUrl(String mode){
		Element ele = (Element)doc.getElementsByTagName("PrintUniMartC2COrderInfo").item(0);
		String url = "";
	...
	public void verifyParams(PrintUniMartC2COrderInfoObj obj){
