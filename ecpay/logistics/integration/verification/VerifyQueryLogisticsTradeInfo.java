...
public class VerifyQueryLogisticsTradeInfo extends LogisticsVerifyBase{
	public VerifyQueryLogisticsTradeInfo(){
		super();
	}
	
	public String getAPIUrl(String mode){
		Element ele = (Element)doc.getElementsByTagName("QueryLogisticsTradeInfo").item(0);
		String url = "";
	...
	public void verifyParams(QueryLogisticsTradeInfoObj obj){
