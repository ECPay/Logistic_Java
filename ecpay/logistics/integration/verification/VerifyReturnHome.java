...
public class VerifyReturnHome extends LogisticsVerifyBase{
	public VerifyReturnHome(){
		super();
	}
	
	public String getAPIUrl(String mode){
		Element ele = (Element)doc.getElementsByTagName("ReturnHome").item(0);
		String url = "";
	...
	public void verifyParams(ReturnHomeObj obj){
