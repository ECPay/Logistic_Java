...
public class VerifyPrintHILIFEC2COrderInfo extends LogisticsVerifyBase{
	public VerifyPrintHILIFEC2COrderInfo(){
		super();
	}
	
	public String getAPIUrl(String mode){
		Element ele = (Element)doc.getElementsByTagName("PrintHILIFEC2COrderInfo").item(0);
		String url = "";
	...
	public void verifyParams(PrintHILIFEC2COrderInfoObj obj){
