...
public class VerifyPrintFAMIC2COrderInfo extends LogisticsVerifyBase{
	public VerifyPrintFAMIC2COrderInfo(){
		super();
	}
	
	public String getAPIUrl(String mode){
		Element ele = (Element)doc.getElementsByTagName("PrintFAMIC2COrderInfo").item(0);
		String url = "";
	...
	public void verifyParams(PrintFAMIC2COrderInfoObj obj){
