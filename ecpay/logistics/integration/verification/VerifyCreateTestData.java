...
public class VerifyCreateTestData extends LogisticsVerifyBase{
	public VerifyCreateTestData(){
		super();
	}
	
	public String getAPIUrl(String mode){
		Element ele = (Element)doc.getElementsByTagName("CreateTestData").item(0);
		String url = "";
	...
	public void verifyParams(CreateTestDataObj obj){
