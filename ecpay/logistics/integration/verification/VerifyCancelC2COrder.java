...
public class VerifyCancelC2COrder extends LogisticsVerifyBase{
	public VerifyCancelC2COrder(){
		super();
	}
	
	public String getAPIUrl(String mode){
		Element ele = (Element)doc.getElementsByTagName("CancelC2COrder").item(0);
		String url = "";
	...
	public void verifyParams(CancelC2COrderObj obj){
